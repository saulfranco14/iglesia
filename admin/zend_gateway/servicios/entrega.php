 ...
 *  @final
 */
final Class Entrega extends Base implements peticiones
{
	/*
	...
	public function __construct()
	{
		...
		if(parent::validaSesion()){
			...
			$this->_columnas = array('', 'entrega.id_entrega','entrega.created_at','entrega.updated_at','entrega.cantidad','entrega.observacion','entrega.fecha_entrega','entrega.prenda_id_prenda', 'entrega.talla_id_talla', 'entrega.modelo_id_modelo','entrega.cliente_id_cliente','entrega.color_id_color');
			...
			$this->_aliasColumnas =' entrega.id_entrega AS a, entrega.created_at AS b,entrega.updated_at AS c, entrega.cantidad AS d, entrega.observacion AS e, entrega.fecha_entrega AS f , entrega.prenda_id_prenda AS g , entrega.talla_id_talla AS h , entrega.modelo_id_modelo AS i, entrega.cliente_id_cliente AS j , entrega.activo AS q, entrega.color_id_color AS r';
			$this->_aliasColumnasColores =' colores_entrega.id_colores_entrega AS k, colores_entrega.created_at AS l,colores_entrega.updated_at AS m, colores_entrega.color_id_color AS n, colores_entrega.cantidad AS o, colores_entrega.entrega_id_entrega AS w';
		}else {
	...
	public function listar($tipo)
	{
		...
		$this->_sql = sprintf("SELECT entrega.id_entrega 		AS a,
								 ...
								 WHERE entrega.id_entrega>=1 ORDER BY entrega.id_entrega DESC;",$this->_aliasColumnasColores);
	...
	public function listarColores($tipo){
		...
		$this->_sql = sprintf("SELECT 
									  ...
									  colores_entrega.id_colores_entrega  	AS k,
									  colores_entrega.created_at     		AS l,
									  colores_entrega.updated_at     		AS m,
									  color.nombre         					AS n,
									  colores_entrega.cantidad 				AS o,
									  entrega.id_entrega					AS t,
									  colores_entrega.entrega_id_entrega    As w,
									...
									ORDER BY colores_entrega.entrega_id_entrega DESC;",$this->_aliasColumnasColores);
		return $this->sentenciaSQL($this->_sql, $this->_tipo);
	}
	...
	public function comboPrenda($tipo){
		...
		$this->_sql = 						"SELECT prenda.id_prenda 		AS a,
													...
													WHERE prenda.modelo_id_modelo = modelo.id_modelo
	...
	public function borrar($registro) 
	{
		...
		$this->_sql 		= sprintf("DELETE FROM entrega WHERE entrega.id_entrega=%s LIMIT 1;",$this->_id_entrega);
		return $this->sentenciaSQL($this->_sql, 5);
