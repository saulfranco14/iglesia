 ...
 *  @final
 */
final Class ColorEntrega extends Base implements peticiones
{
	/*
	...
	public function listar($tipo)
	{
		...
		$this->_sql = sprintf("SELECT %s FROM entrega WHERE entrega.id_entrega>=1 ORDER BY entrega.id_entrega DESC;",$this->_aliasColumnas);
