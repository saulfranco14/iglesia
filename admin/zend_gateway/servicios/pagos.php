 ...
 *  @final
 */
final Class Pagos extends Base implements peticiones
{
	/*
	 ...
	 */
	public function listaSemanal2Semanas($tipo)
	{
		...
		$this->_sql = sprintf("SELECT 
									...
									WHERE 
									week( trabajo.created_at,1)= week( DATE_ADD(NOW(),INTERVAL -7 DAY) ) 
	 ...
	 * @return object El juego de resultados (puede ser un json, array o resultSet)
	 */
	public function listaSemanal1Semana($tipo)
	{
		...
		$this->_sql = sprintf("SELECT 
									...
									WHERE 
									week( trabajo.created_at,1 )= week( DATE_ADD(NOW(),INTERVAL -1 DAY) ) 
								    group by usuario.id_usuario
	 ...
	 * @return object El juego de resultados (puede ser un json, array o resultSet)
	 */
	public function listaSemanal2Semana($tipo)
	{
	...
	public function listar($tipo)
	{
		...
		$this->_sql = sprintf("SELECT 
									...
									WHERE 
									week( trabajo.created_at,1 )= week( now(),1 ) 
								    group by usuario.id_usuario
	 ...
	 * @return object El juego de resultados (puede ser un json, array o resultSet)
	 */
	public function listaSemanalLunes($tipo)
	{
		...
		$this->_sql = sprintf("SELECT 
									...
									WHERE 
									week( trabajo.created_at ,1)= week( now(),1 ) and

									WEEKDAY(trabajo.created_at) = 0
	 ...
	 * @return object El juego de resultados (puede ser un json, array o resultSet)
	 */
	public function listaSemanalMartes($tipo)
	{
	 ...
	 * @return object El juego de resultados (puede ser un json, array o resultSet)
	 */
	public function listaSemanalMiercoles($tipo)
	{
	 ...
	 * @return object El juego de resultados (puede ser un json, array o resultSet)
	 */
	public function listaSemanalJueves($tipo)
	{
	 ...
	 * @return object El juego de resultados (puede ser un json, array o resultSet)
	 */
	public function listaSemanalViernes($tipo)
	{
	 ...
	 * @return object El juego de resultados (puede ser un json, array o resultSet)
	 */
	public function listaSemanalSabado($tipo)
	{
	 ...
	 * @return object El juego de resultados (puede ser un json, array o resultSet)
	 */
	public function listaSemanalDomingo($tipo)
	{
	...
	{
		$this->_tipo = intval($tipo);
		$this->_sql = 						"SELECT entrega.id_entrega 			AS a,
													...
													WHERE entrega.id_entrega>=1
													ORDER BY entrega.id_entrega DESC;";
		return $this->sentenciaSQL($this->_sql, $this->_tipo);
	}
